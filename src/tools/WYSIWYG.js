    ...
    editorRender() {
        return `<div class="wysiwyg-editor">
            <div class="wysiwyg-toolbar">
                ...
                <button @click="document.execCommand('insertUnorderedList')" title="Bullet List">•</button>
                <button @click="document.execCommand('insertOrderedList')" title="Numbered List">#</button>
                <button @click="document.execCommand('createLink', false, prompt('Enter link URL'))" title="Link">🔗</button>
            </div>
            <${this.config.format} 
