...
class $cda2b75602dff697$export$7cda8d932e2f33c0 {
   ...
   */ initBlock(blockName, push = false, existingId = null) {
        ...
        const blockId = existingId && existingId !== 'undefined' && existingId !== 'null' ? existingId : (0, $c9716fc55d08135c$export$567fc7097e064344)();
   ...
   */ handleTemplateDrop(template, blockId = null) {
        try {
            ...
            for (const blockData of blocks){
                ...
                const blockId = (0, $c9716fc55d08135c$export$567fc7097e064344)();
                const newBlock = new BlockClass({
                    id: blockId,
                    updateFunction: this.updateFunction.bind(this),
                    config: mergedConfig
 ...
 */ class $872dae2f63901d99$export$27d9ef0ef15a29ab {
    /**
...
class $299948f22c89836d$export$c72f6eaae7b9adff {
   ...
   */ init() {
        ...
        document.addEventListener('template-selected', (event)=>{
            (0, $4c0d28162c26105d$export$153e5dc2c098b35c).debug('Settings: Received template-selected event', event.detail);
    ...
    handleBlockChanged(blockId) {
        ...
        if (window.alpineEditors && window.alpineEditors[this.editorId]) {
            ...
            (0, $4c0d28162c26105d$export$153e5dc2c098b35c).debug('Settings: Block type', blockType, 'for block', blockId);
            if (blockType === 'WYSIWYG') {
                // Inject RichTextEditor-specific properties
                this.injectRichTextEditorProperties(block);
                (0, $4c0d28162c26105d$export$153e5dc2c098b35c).debug('Settings: Injected RichTextEditor properties for block', blockId);
            }
   ...
   */ parseCSSPropertiesFromBlock(blockId) {
        ...
        if (this.currentElement) {
            if (this.currentElement.hasAttribute('style')) {
                const styleString = this.currentElement.getAttribute('style');
                this.cssProperties = (0, $872dae2f63901d99$export$27d9ef0ef15a29ab).parseCSSProperties(styleString);
                (0, $4c0d28162c26105d$export$153e5dc2c098b35c).debug('Settings: Parsed CSS from stored element', this.cssProperties);
            } else {
                this.cssProperties = {};
                (0, $4c0d28162c26105d$export$153e5dc2c098b35c).debug('Settings: No styles on stored element');
            }
            return;
        }
        ...
        (0, $4c0d28162c26105d$export$153e5dc2c098b35c).debug('Settings: Found element for block', blockId, element);
        // Parse the inline style attribute
        if (element && element.hasAttribute('style')) {
            const styleString = element.getAttribute('style');
            this.cssProperties = (0, $872dae2f63901d99$export$27d9ef0ef15a29ab).parseCSSProperties(styleString);
            (0, $4c0d28162c26105d$export$153e5dc2c098b35c).debug('Settings: Parsed CSS properties', this.cssProperties);
        } else {
            this.cssProperties = {};
            (0, $4c0d28162c26105d$export$153e5dc2c098b35c).debug('Settings: No styles found on element');
        }
    }
    /**
   ...
   */ updateCSSProperty(property, value) {
        if (!this.currentBlockId) {
            (0, $4c0d28162c26105d$export$153e5dc2c098b35c).warn('No block selected for CSS update');
            return;
        }
   ...
   */ applyStylesToBlock() {
        ...
        if (this.currentElement) {
            const styleString = (0, $872dae2f63901d99$export$27d9ef0ef15a29ab).buildStyleString(this.cssProperties);
            this.currentElement.setAttribute('style', styleString);
            (0, $4c0d28162c26105d$export$153e5dc2c098b35c).debug('Settings: Applied styles to stored element', styleString);
        ...
        (0, $4c0d28162c26105d$export$153e5dc2c098b35c).debug('Settings: Applying styles to element', this.currentBlockId, element);
        if (element) {
            // Build the style string and apply it
            const styleString = (0, $872dae2f63901d99$export$27d9ef0ef15a29ab).buildStyleString(this.cssProperties);
            element.setAttribute('style', styleString);
            (0, $4c0d28162c26105d$export$153e5dc2c098b35c).debug('Settings: Applied style string', styleString);
            // Save state if available
            if (editorInstance.debouncedSaveState) editorInstance.debouncedSaveState();
        } else (0, $4c0d28162c26105d$export$153e5dc2c098b35c).warn('Settings: Could not find element to apply styles to', this.currentBlockId);
    }
    /**
   ...
   */ injectRichTextEditorProperties(block) {
        ...
        if (!window.AlpineBlocks || !window.AlpineBlocks.RichTextEditor) {
            (0, $4c0d28162c26105d$export$153e5dc2c098b35c).warn('RichTextEditor not available - cannot inject properties');
            return;
        }
        ...
        (0, $4c0d28162c26105d$export$153e5dc2c098b35c).debug('Settings: Added RichTextEditor properties HTML', propertiesHTML.substring(0, 100) + '...');
    }
    /**
 ...
 */ class $0b5a35bcb6563323$export$839910c5ffe56f19 {
...
class $9aaf352ee83751f3$var$RichTextLoader {
   ...
   */ initializeSingleEditor(element, config) {
        ...
        if (element.tagName === 'TEXTAREA') {
            ...
            historyManager = new (0, $0b5a35bcb6563323$export$839910c5ffe56f19)(editorDiv, {
...
class $806caca8705a7215$var$WYSIWYG extends (0, $7a9b6788f4274d37$export$2e2bcd8739ae039) {
    ...
    init(editor) {
        ...
        if (editor && editor.$nextTick) editor.$nextTick(()=>{
            ...
            if (textarea) (0, $9aaf352ee83751f3$export$2e2bcd8739ae039).init(`#${this.editorId}`, {
                features: this.config.features,
                height: 200,
                onChange: (content)=>{
...
if (typeof window !== 'undefined') {
    ...
    window.AlpineBlocks.toolModules = $54dbff4655f90a4d$export$1c6f616578103705;
}
...
class $f437e8e0685a19d7$var$RichTextEditor {
   ...
   */ static createRichTextPropertiesHTML() {
        ...
        return (0, $9aaf352ee83751f3$export$2e2bcd8739ae039).constructor.createRichTextPropertiesHTML();
    }
}
